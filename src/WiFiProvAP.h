/*
 Name:		WiFiProvAP.h
 Created:	11/3/2022 10:00:35 AM
 Author:	podaen
*/
//API is based on the original work:
...
//Provisioning class 
class WiFiProvClassAP
{
public:

    void beginProvisionAP(prov_scheme_t prov_scheme = WIFI_PROV_SCHEME_SOFTAP, scheme_handler_t scheme_handler = WIFI_PROV_SCHEME_HANDLER_NONE,
...
extern WiFiProvClassAP WiFiProvAP;
